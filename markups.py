...
btnaloqaMenu = ReplyKeyboardMarkup(resize_keyboard = True).add(btnaloqa1).add(btnaloqa2).add(btnaloqa3).add(btnaloqa4).add(btnMain)
#-----><<><><><><><><><><><><><><><><><><><><><><><>><><><><--------------------[[][][][][[[][][][][]][-----------------#
#-----><<><><><><><><><><><><><><><><><><><><><><><>><><><><--------------------[[][][][][[[][][][][]][-----------------#
#-----><<><><><><><><><><><><><><><><><><><><><><><>><><><><--------------------[[][][][][[[][][][][]][-----------------#
...
itbook0 = KeyboardButton("JavaScript")
itbook1 = KeyboardButton("Php")
itbook2 = KeyboardButton("Python")
itbook3 = KeyboardButton("Java")
itbook4 = KeyboardButton("HTML")
itbook5 = KeyboardButton("CSS")
menuebooks = ReplyKeyboardMarkup(resize_keyboard=True).add(itbook0).add(itbook1).add(itbook2).add(itbook3).add(itbook4).add(itbook5).add(btnMain)
...
pythonbook0 = KeyboardButton("Django kitoblar")
pythonbook1 = KeyboardButton("O'quv qo'llanmalri")
menupythonbooks = ReplyKeyboardMarkup(resize_keyboard=True).add(pythonbook0).add(pythonbook1).add(btnMain)
...
enbook = KeyboardButton("Murphy books")
enbook1 = KeyboardButton("Test master")
enbook2 = KeyboardButton("Other books")
menuenbooks = ReplyKeyboardMarkup(resize_keyboard=True).add(enbook).add(enbook1).add(enbook2).add(btnMain)
...
enbooks = KeyboardButton("English books")
rusbooks = KeyboardButton("Ruscha kitoblar")
ebooks = KeyboardButton("Dasturlash kitoblari")
tedbookbook = KeyboardButton("TedBook kitobi")
...
btnfollowers = KeyboardButton("Statistika")
mainMenu = ReplyKeyboardMarkup(resize_keyboard=True).add(btnDarsliklar).add(tedbookbook).add(btnBadiiy).add(enbooks).add(rusbooks).add(sam).add(sam3).add(sam4).add(sam7).add(sam8).add(sam9).add(sam10).add(sam11).add(sam12).add(sam13).add(sam14).add(ebooks).add(btnfizika).add(btnbiologiyaKimyo).add(btnInglizTiliBilimdon).add(btnRusTiliBilimdon).add(btnsheriyat).add(btnAlisherNavoiy).add(btnIslomKarimov).add(btnShavkatMirziyoyev).add(sam15).add(btnfollowers).add(sam16).add(btnAloqa)
